        ...
        <Box className={classes.section}>
          <Box className={classes.row}>
            <Box className={classes.column}>
              ...
              <Typography className={classes.value}>{user?.data?.initialUserData?.name}</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
              <Typography className={classes.title}>Device ID</Typography>
              <Typography className={classes.value}>W-HMS-X {user?.data?.deviceId}</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
              <Typography className={classes.title}>Phone number</Typography>
              <Typography className={classes.value}>{user?.data?.initialUserData?.phone}</Typography>
            </Box>
          </Box>
        </Box>
        <Divider className={classes.divider} />
        <Box className={classes.section}>
          <Box className={classes.row}>
            <Box className={classes.column}>
              ...
              <Typography className={classes.value}>{user?.data?.environmentData?.name}</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
              <Typography className={classes.title}>DOB</Typography>
              <Typography className={classes.value}> {user?.data?.profileData?.dob.substring(
                                        2,
                                        11
                                      )}</Typography>
            </Box>
            <Box className={classes.column}>
              ...
              <Typography className={classes.value}>{user?.data?.profileData?.weight} Kgs</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
              <Typography className={classes.title}>Height</Typography>
              <Typography className={classes.value}>{user?.data?.profileData?.height} cm</Typography>
            </Box>
            <Box className={classes.column}>
              <Typography className={classes.title}>Gender</Typography>
              <Typography className={classes.value}>{user?.data?.profileData?.gender}</Typography>
            </Box>
          </Box>
        </Box>
        <Divider className={classes.divider} />
        <Box className={classes.section}>
          <Box className={classes.row}>
            <Box className={classes.column}>
              ...
              <Typography className={`${classes.value} ${classes.greenText}`}>Active</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
              <Typography className={classes.title}>Admin</Typography>
              <Typography className={classes.value}>{AuthUser.displayName}</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
        ...
        <Box className={classes.section}>
          <Box className={classes.row}>
            <Box className={classes.column}>
              ...
              <Typography className={classes.value}>Hypertension, High blood Pressure</Typography>
            </Box>
          </Box>
          <Box className={classes.row}>
            <Box className={classes.column}>
          ...
          {sensorData[key] ? (
            ...
            >
              ...
              <Grid container alignItems="center" spacing={1}>
                <Grid item>
                  <FavoriteIcon style={{ color: '#7CD6AB', fontSize: '1rem' }} />
                </Grid>
                <Grid item>
                  <Typography
                    variant="body2"
