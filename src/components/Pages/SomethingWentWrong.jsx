...
function SomethingWentWrong() {
  ...
  return <>
   <div className="moon"></div>
            ...
            <div className="error">
            <div className="error__title">500</div>
            <div className="error__subtitle">Hmmm...</div>
            <div className="error__description">It looks like one of the  developers fell asleep <br/> Something Went Wrong</div>
